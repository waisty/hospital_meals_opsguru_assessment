...
namespace Hospital.Meals.Core.Contracts
{
    public interface IPatientRequestHandler
    {
        ...
        Task<PagedResult<PatientRequestViewModel>> ListPatientRequestsAsync(int page, int pageSize, string? search = null, CancellationToken cancellationToken = default);
    }
}
