...
namespace Hospital.Meals.Core.Contracts
{
    public interface IIngredientHandler
    {
        ...
        Task<IngredientExclusionNamesResponse> GetExclusionNamesByIngredientIdsAsync(IngredientExclusionNamesRequest request, CancellationToken cancellationToken = default);
    }
}
